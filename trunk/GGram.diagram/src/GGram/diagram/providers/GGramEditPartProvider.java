 ...
 * @generated
 */
public class GGramEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public GGramEditPartProvider() {
		setFactory(new GGram.diagram.edit.parts.GGramEditPartFactory());

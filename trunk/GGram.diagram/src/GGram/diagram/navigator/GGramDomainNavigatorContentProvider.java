 ...
 * @generated
 */
public class GGramDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public GGramDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof GGram.diagram.navigator.GGramDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier
							.getChildren(((GGram.diagram.navigator.GGramDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result
						.add(new GGram.diagram.navigator.GGramDomainNavigatorItem(

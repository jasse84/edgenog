 ...
 * @generated
 */
public class GGramNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					GGram.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof GGram.diagram.navigator.GGramNavigatorItem) {
					selectedElement = ((GGram.diagram.navigator.GGramNavigatorItem) selectedElement)
							.getView();

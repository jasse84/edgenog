 ...
 * @generated
 */
public class ManItemSemanticEditPolicy extends
		GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ManItemSemanticEditPolicy() {
		super(GGram.diagram.providers.GGramElementTypes.Man_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.EngagementEditPart.VISUAL_ID) {
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.CohabitationEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.CohabitationAndSeparationEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.MarriageEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.LoveAffairEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.NullityEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.DivorceEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (GGram.diagram.part.GGramVisualIDRegistry
					.getVisualID(incomingLink) == GGram.diagram.edit.parts.RelationshipEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
						incomingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));

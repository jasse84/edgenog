 ...
 * @generated
 */
public class EngagementReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EngagementReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Engagement) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEngagement_4001(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistEngagement_4001(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Engagement getLink() {
		return (GGram.Engagement) getElementToEdit();
	}

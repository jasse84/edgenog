 ...
 * @generated
 */
public class MarriageReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MarriageReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Marriage) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMarriage_4005(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMarriage_4005(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Marriage getLink() {
		return (GGram.Marriage) getElementToEdit();
	}

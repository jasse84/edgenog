 ...
 * @generated
 */
public class LoveAffairReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LoveAffairReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.LoveAffair) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLoveAffair_4006(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLoveAffair_4006(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.LoveAffair getLink() {
		return (GGram.LoveAffair) getElementToEdit();
	}

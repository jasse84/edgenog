 ...
 * @generated
 */
public class NullityReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NullityReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Nullity) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistNullity_4007(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistNullity_4007(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Nullity getLink() {
		return (GGram.Nullity) getElementToEdit();
	}

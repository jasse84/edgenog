 ...
 * @generated
 */
public class HasAdoptedChildReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HasAdoptedChildReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.HasAdoptedChild) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistHasAdoptedChild_4010(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistHasAdoptedChild_4010(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.HasAdoptedChild getLink() {
		return (GGram.HasAdoptedChild) getElementToEdit();
	}

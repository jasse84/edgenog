...
public class RelationshipReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Relationship) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRelationship_4009(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRelationship_4009(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Relationship getLink() {
		return (GGram.Relationship) getElementToEdit();
	}

 ...
 * @generated
 */
public class DivorceReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DivorceReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Divorce) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDivorce_4008(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDivorce_4008(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Divorce getLink() {
		return (GGram.Divorce) getElementToEdit();
	}

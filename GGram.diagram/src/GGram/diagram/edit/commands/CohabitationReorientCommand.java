 ...
 * @generated
 */
public class CohabitationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CohabitationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof GGram.Cohabitation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCohabitation_4003(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		GGram.Genogram container = (GGram.Genogram) getLink().eContainer();
		return GGram.diagram.edit.policies.GGramBaseItemSemanticEditPolicy.LinkConstraints
				.canExistCohabitation_4003(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected GGram.Cohabitation getLink() {
		return (GGram.Cohabitation) getElementToEdit();
	}
